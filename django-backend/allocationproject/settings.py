"""
Django settings for allocationproject project.
...
SECRET_KEY = 'django-insecure-6=mmc^p34@-djh(in&i@i$j-zl1xbb1*@slt$f)(4o-(w35$9c'
...
AUTH_USER_MODEL = "allocationapp.CustomUser"
...
ROOT_URLCONF = 'allocationproject.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'template_filters': 'allocationapp.template_filters',
            }
        },
    },
]

WSGI_APPLICATION = 'allocationproject.wsgi.application'
